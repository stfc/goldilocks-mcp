...
To add goldilocks-mcp to Claude Descktop copy the content of claude_desktop_config.json to 
...
(for Windows instructions can be found at https://modelcontextprotocol.io/docs/develop/build-server)
